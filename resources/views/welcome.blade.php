        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
                ...
                <nav class="bg-indigo-300 w-full h-20 hidden fixed top-0 right-0 px-6 py-4 sm:block sm:justify-between items-center">
                    ...
                    <div class="ml-72 space-x-16">
                            <a href="{{ url('/home') }}" class="text-2xl text-white font-serif">About</a>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="mt-8 bg-white dark:bg- overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <img src="Images\PixarLogo.jpg" class="rounded-md"  width="300" height="200" alt="Pixar Title Image">
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                <img src="Images\MarvelLogo.jpg" class="rounded-md" width="300" height="200" alt="Marvel Title Image">
                            </div>
                        </div>
